...
const menu1 = (
  <Menu>
    ...
    <Menu.Item danger>拍卖交易</Menu.Item>
  </Menu>
);
...
export default class IndexPage extends React.Component<IProps, state> {
  ...
  private rightBtnStyle = {
    display: "block",
    color: "blue",
  };
  private rightBtnStyle2 = {
    display: "none",
    color: "red",
  };
  render() {
          ...
          <div className="content">
            <div className="friend_link_box">
              <div className="friend_link_tit clearfix">
                ...
                <a style={{ textDecoration: "none" }}>
                  {/* <a href="" className={["", this.state.selected ? "now":null].join(' ')} style={{ textDecoration: "none" }} > */}
                  推荐专题
                </a>
              </div>
              <div className="friend_link_list clearfix m_t10">
                ...
                <div className="f_box" style={{ display: "none" }}>
                  <ul>
                    ...
                    <li>
                      <a href="http://www.bookschina.com/" target="_blank">
                        中国图书网
                      </a>{" "}
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="http://www.southmoney.com/" target="_blank">
                        股票
                      </a>{" "}
                    </li>
                    <li>
                ...
                <div className="f_box" style={{ display: "block" }}>
                  <ul>
                    ...
                    <li>
                      <a href="http://www.kongfz.com/topic/" target="_blank">
                        热搜专题
                      </a>{" "}
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="http://www.kongfz.com/writer/" target="_blank">
                        作家大全
                      </a>{" "}
                    </li>
                    <li>
                      <a href="https://shoushu.kongfz.com/" target="_blank">
                        上门收书
                      </a>{" "}
                    </li>
                    <li>
