...
export default class IndexPage extends React.Component<IProps, State> {
  static async getInitialProps() {
    const res = await fetch("http://localhost:3001/literature");
                    ...
                    <ul className="subject-list">
                      {data &&
                        ...
                        data
                          ...
                          .map((item: any) => {
                            return (
                              <Link href="/literature/[id]" as={`/literature/${item.bookId}`} key={item.bookId}>
                              <li className="subject-item" key={item.bookId}>
                                <div className="pic">
                                  <a href="">
                                    <img
                                      src={`../static/images/image/${item.imgPath}`}
                                      style={{ width: "90px", height: "133px" }}
                                    />
                                  </a>
                                </div>
                                <div className="info">
                                  ...
                                  <div className="pub">
                                    ...
                                    {item.publicationYear}年 / {item.bookPrice}
                                    元
                                  </div>
